export const games = [
  ...
  },
  {
    ...
    name: '다이사이',
    englishName: 'Sic Bo',
    description: '3개의 주사위 합과 조합을 예측하는 아시아 전통 게임',
    minBet: '₩1,000',
    maxBet: '₩500,000',
    houseEdge: '2.78%',
    rtp: '97.22%',
    image: '/images/sicbo.jpg',
    features: ['다양한 베팅', '빠른 진행', '높은 배당'],
    rules: {
      objective: '3개 주사위의 합계나 조합을 예측하여 베팅합니다.',
      basicRules: [
        '플레이어는 베팅 테이블에 칩을 놓아 베팅합니다.',
        '딜러가 3개의 주사위를 굴립니다.',
        '주사위 결과에 따라 승패가 결정됩니다.'
      ]
    },
    payouts: [
      { condition: '소/대', payout: '1:1' },
      { condition: '합계 4 또는 17', payout: '60:1' },
      { condition: '애니 트리플', payout: '30:1' },
      { condition: '특정 트리플', payout: '180:1' }
    ]
  }
];